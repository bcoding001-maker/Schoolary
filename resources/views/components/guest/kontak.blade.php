...
<section id="kontak" class="section-spacing relative overflow-hidden">
    ...
    <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-12">
            <h2 class="text-3xl font-bold text-slate-700 mb-3">Hubungi Kami</h2>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div class="glass-card rounded-2xl p-8 hover-lift">
                <form class="space-y-6">
                    ...
                    <div>
                        <button type="submit" class="elegant-button w-full py-3 rounded-lg text-white font-medium bg-gradient-to-r from-indigo-500 to-purple-500 shadow-md hover:from-indigo-600 hover:to-purple-600">
                            Kirim Pesan
                        </button>
                    </div>
                </form>
