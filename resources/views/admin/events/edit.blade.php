        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-xl overflow-hidden relative">
                <div class="p-4 sm:p-8">
                    <form method="POST" 
                          action="{{ route('admin.events.update', $event->event_id) }}" 
                        ...
                        <div class="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6">
                            ...
                            <div class="space-y-4 sm:space-y-6">
                                ...
                                <div class="relative group">
                                    ...
                                    <!-- Image Preview -->
                                    <div id="imagePreview" class="mt-4 {{ $event->thumbnail ? '' : 'hidden' }}">
                                        <div class="relative inline-block">
                                            <img id="preview" 
                                                 src="{{ $event->thumbnail ? asset('storage/events/' . $event->thumbnail) : '#' }}" 
                                                 alt="Preview" 
